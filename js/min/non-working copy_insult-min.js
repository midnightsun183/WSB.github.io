...
l=n[Math.floor(Math.random()*n.length)];
  return[t,e,l]}function n()
  {var n=a(".fucking.description .sentence");
  e=s(o,r,p),l=e[2],a(".insult h1.ass").html(e[0]+" "+e[1]),
  n.html(e[2]),n.find("span.ass").html(e[0]+" "+e[1]),
  n.find("span.aan").html(t(e[0]))}function t(a)
  {return"a"===a.toLowerCase().charAt(0)?"an":"a"}var e="",l="",o=[
    "Ass",
    "Bitch",
    "Butt",
    "Cock",
...
a("button.damn").on("click",n),n(),a("a.twitter-share-button").on("click",
  function(s){var n=a(this).attr("href"),o=n.split("text="),
  r=l.replace("<span class='ass'></span>",
    e[0]+" "+e[1]);
  r=r.replace("<span class='aan'></span>",
  t(e[0]));var p=o[0]+"text="+e[0]+" "+e[1]+' (noun) "'+r+'" Get yours at';
